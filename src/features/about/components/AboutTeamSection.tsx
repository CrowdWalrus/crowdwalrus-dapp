...
const TEAM = [
  { name: "Alireza", role: "Tech" },
  { name: "MoeNick", role: "Product" },
  { name: "Ahmad", role: "Business" },
  { name: "Freshelle", role: "Finance" },
  { name: "Mo", role: "UI / UX" },
  { name: "Griff", role: "Advisor" },
];
        ...
        <div className="flex flex-col gap-16 py-20 sm:py-28 lg:py-32">
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <p className="max-w-[700px] text-lg text-black-300">
              ...
              partnership with <strong className="text-black-500">Walrus</strong>
              . Built by former Giveth contributors with deep experience in
              blockchain, product, and ecosystem building.
            </p>
          </div>
